...
$(function() {
    ...
    $("#business_calc").on("click", function() {
        0 <= $(this).attr("class").indexOf("normal-tab") && ($(this).removeClass("normal-tab").addClass("select-tab").siblings(".tab").removeClass("select-tab").addClass("normal-tab"), $("#business_sum_line").show(), $("#business_sum_line_divider").show(), $("#business_rate_select_line").show(), $("#business_rate_select_line_divider").show(), $("#business_rate_value_line").show(), $("#PAF_sum_line").hide(), $("#PAF_sum_line_divider").hide(), $("#PAF_rate_line").hide(), $("#PAF_rate_line_divider").hide(), $("#business_interest_total_debx").hide(), $("#PAF_interest_total_debx").hide(), $("#business_interest_total_debj").hide(),
            $("#PAF_interest_total_debj").hide(), $("#business_atc_recmd_mod").show(), $("#PAF_atc_recmd_mod").hide(), loanType = 0)
    });
    $("#PAF_calc").on("click", function() {
        0 <= $(this).attr("class").indexOf("normal-tab") && ($(this).removeClass("normal-tab").addClass("select-tab").siblings(".tab").removeClass("select-tab").addClass("normal-tab"), $("#PAF_sum_line").show(), $("#PAF_sum_line_divider").show(), $("#PAF_rate_line").show(), $("#PAF_rate_line_divider").show(), $("#business_sum_line").hide(), $("#business_sum_line_divider").hide(), $("#business_rate_select_line").hide(), $("#business_rate_select_line_divider").hide(), $("#business_rate_value_line").hide(), $("#business_interest_total_debx").hide(),
    ...
    $("#mix_calc").on("click", function() {
        0 <= $(this).attr("class").indexOf("normal-tab") && ($(this).removeClass("normal-tab").addClass("select-tab").siblings(".tab").removeClass("select-tab").addClass("normal-tab"), $("#business_sum_line").show(), $("#business_sum_line_divider").show(), $("#business_rate_select_line").show(), $("#business_rate_select_line_divider").show(), $("#business_rate_value_line").show(),
            $("#PAF_sum_line").show(), $("#PAF_sum_line_divider").show(), $("#PAF_rate_line").show(), $("#PAF_rate_line_divider").show(), $("#business_interest_total_debx").show(), $("#PAF_interest_total_debx").show(), $("#business_interest_total_debj").show(), $("#PAF_interest_total_debj").show(), $("#business_atc_recmd_mod").show(), $("#PAF_atc_recmd_mod").hide(), loanType = 2)
    });
    ...
    $("#loan_period_select").on("change", function() {
        ...
        $("#loan_period_select_bar").text($(this).find("option:selected").text().trim());
    ...
    $("#business_rate_select").on("change", function() {
        var a = $(this).val();
        businessRateType = a;
        $("#business_rate_select_bar").text($(this).find("option:selected").text().trim());
    ...
    $("#business_discount").on("change", function() {
        ...
        $("#business_discount_bar").text($(this).find("option:selected").text().trim());
    ...
    $("#PAF_rate_select").on("change", function() {
        var a = $(this).val();
        PAFRateType = a;
        $("#PAF_rate_select_bar").text($(this).find("option:selected").text().trim());
    ...
    // 等额本息
    $("#result_tab_1").on("click", function() {
        calculateAndShow(1);
    });
    // 等额本金
    $("#result_tab_2").on("click", function() {
        calculateAndShow(2);
    });
...
function calculateAndShow(repayType) {
    calculate(repayType); // 计算
    showResult(repayType); // 显示计算结果
}
...
function calculate(repayType) { // repayType表示偿还类型 1:等额本息  2:等额本金 
    ...
    $("#result_tab_" + repayType).removeClass("normal-tab").addClass("select-tab").siblings(".result-tab").removeClass("select-tab").addClass("normal-tab");
    $("#result_data_" + repayType).show().siblings(".result-data").hide();
    showResultTabID = repayType
...
function showResult(repayType) {
    $("#data_detail_" + repayType).show().siblings(".data-container").hide();
